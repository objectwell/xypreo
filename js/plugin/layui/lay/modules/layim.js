        ...
        status: function (i, a) {
            ...
            layui.upload.render({
                ...
                accept: a,
                    ...
                    // gzky  修改后台返回数据
                    200 == i.code ? (i.data = i.data || {}, "images" === a ? ai(n.textarea[0], "img[" + (i.data.src || "") + "]") : "file" === a && ai(n.textarea[0], "file(" + (i.data.src || "") + ")[" + (i.data.name || "下载文件") + "]"), D()) : t.msg(i.msg || "上传失败")
                }
            })
        }, media: function (i) {
