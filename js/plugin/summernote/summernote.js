      ...
      function Editor(context) {
          ...
          this.floatMe = this.wrapCommand(function (value) {
            ...
            //   $target.css('float', (value === 'none' ? '' : value));
              if(value=='center'){$target.css('margin', '0 auto');$target.css('float', 'none');$target.css('display', 'block')}else {
                $target.css('float', value);$target.css('margin', '')
              }
          });
          /**
  ...
  var Buttons = /** @class */ (function () {
      ...
      Buttons.prototype.addImagePopoverButtons = function () {
          ...
          this.context.memo('button.floatCenter', function () {
            return ui.button({
              contents: ui.icon(_this.options.icons.alignCenter),
